...
[验收清单]
    ...
    导演讲戏质量（每个剧情点单独评分 1-10）
        ...
        □ 无旁白（短剧红线）：短剧中**不允许使用旁白/画外音叙事**。所有叙事信息须通过台词、动作、画面和音效传达。检查每个剧情点是否存在"旁白响起""画外音""内心独白"等标记——如果有，必须 FAIL 并要求修改为通过台词/动作表达。注意：角色正常的内心独白（角色自己说话）不被视为旁白，但标注为"旁白 Narration"的第三方叙述性声音必须禁止。
